...
<Steps>
  <Step title="Create your company account">
    Contact Forager support to provision your company account. You will receive an admin invite by email.
  </Step>
  <Step title="Accept your admin invite">
    Click the link in your invite email and set your password. You are now the account admin.
  </Step>
  <Step title="Invite your team">
    In the dashboard, go to **Team** and invite your field technicians. They will receive email invites and download the Forager Android app.
  </Step>
</Steps>
...
If your organization uses ServiceNow or another CMDB, configure a webhook to push every attestation automatically.
